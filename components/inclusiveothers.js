  ...
  render() {
    return (
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        <Text style={{fontSize: 18, margin: 4}}><Text style= {{fontWeight: 'bold'}}>Children’s Discovery Museum San Jose: Play Your Way                                                            </Text>{"\n"}Normally in February, April, September every year</Text>
